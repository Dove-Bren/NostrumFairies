...
//				'C', NostrumResourceItem.getItem(ResourceType.CRYSTAL_LARGE, 1));
	...
	public static class FarmingBlockTileEntity extends LogisticsTileEntity implements ITickable,  ILogisticsTaskListener {
	...
	public static class FarmingBlockRenderer extends TileEntityLogisticsRenderer<FarmingBlockTileEntity> {
