...
public class StorageChestGui {
	...
	public static class StorageChestContainer extends AbstractContainerMenu {
		...
		public StorageChestContainer(int windowId, Inventory playerInv, StorageChestTileEntity chest) {
		...
		public static StorageChestContainer FromNetwork(int windowId, Inventory playerInv, FriendlyByteBuf buf) {
	...
	public static class StorageChestGuiContainer extends AutoGuiContainer<StorageChestContainer> {
		...
		public StorageChestGuiContainer(StorageChestContainer container, Inventory playerInv, Component name) {
