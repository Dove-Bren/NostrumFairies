...
public class FairyScreenGui {
	...
	private static final ResourceLocation TEXT = new ResourceLocation(NostrumFairies.MODID + ":textures/gui/container/fairy_container_temp.png");
	...
	public static class FairyScreenContainer extends Container {
		
		protected FairyHolderInventory inv;
		
		public FairyScreenContainer(IInventory playerInv, FairyHolderInventory chest) {
			this.inv = chest;
