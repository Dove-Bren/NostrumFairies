...
public class ModelBuildingDwarf extends ModelDwarf<EntityDwarfBuilder> {
	...
	protected ModelRenderer createHammer() {
		...
		hammer.addBox("", -4.0F, -18.5F + yOffset, -2.5F, 7, 4, 6, 0f, 88, 15);
		hammer.addBox("", -5.0F, -19.0F + yOffset, -3.0F, 1, 5, 7, 0f, 88, 38);
		hammer.addBox("", 3.0F, -19.0F + yOffset, -3.0F, 1, 5, 7, 0f, 88, 25);
		hammer.addBox("", -1.0F, -15.0F + yOffset, 0.0F, 1, 15, 1, 0f, 84, 15);
