...
public class FairyEntities {
	...
	public static void registerEntityTypes(RegistryEvent.Register<EntityType<?>> event) {
		...
		registry.register(EntityType.Builder.<EntityGnomeCollector>create(EntityGnomeCollector::new, EntityClassification.CREATURE).size(0.45F, .3F).setTrackingRange(128).setUpdateInterval(1).setShouldReceiveVelocityUpdates(false).build("").setRegistryName(EntityGnomeCollector.ID));
		registry.register(EntityType.Builder.<EntityGnomeCrafter>create(EntityGnomeCrafter::new, EntityClassification.CREATURE).size(0.45F, .3F).setTrackingRange(128).setUpdateInterval(1).setShouldReceiveVelocityUpdates(false).build("").setRegistryName(EntityGnomeCrafter.ID));
