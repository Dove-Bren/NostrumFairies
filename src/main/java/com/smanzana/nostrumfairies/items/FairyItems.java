...
public class FairyItems {
	...
	@ObjectHolder(FairyInstrument.ID_HARP) public static FairyInstrument harpFlute;
	@ObjectHolder(FairyInstrument.ID_OCARINA) public static FairyInstrument ocarinaFlute;
	...
	public static void registerItems(RegistryEvent.Register<Item> event) {
		...
		register(registry, new FeyResource(SoulStoneType.GEM).setRegistryName(FeySoulStone.ID_SOUL_GEM));
		register(registry, new FeyResource(SoulStoneType.GAEL).setRegistryName(FeySoulStone.ID_SOUL_GAEL));
		register(registry, new FeyStone(FeySlotType.SPECIALIZATION, FeyStoneMaterial.EMERALD).setRegistryName(ID_SPEC_EMERALD));
		register(registry, new FeyStone(FeySlotType.SPECIALIZATION, FeyStoneMaterial.GARNET).setRegistryName(ID_SPEC_GARNET));
		register(registry, new FeyStone(FeySlotType.SPECIALIZATION, FeyStoneMaterial.AQUAMARINE).setRegistryName(ID_SPEC_AQUAMARINE));
		register(registry, new FeyStone(FeySlotType.SPECIALIZATION, FeyStoneMaterial.RUBY).setRegistryName(ID_SPEC_RUBY));
		register(registry, new FeyStone(FeySlotType.SPECIALIZATION, FeyStoneMaterial.SAPPHIRE).setRegistryName(ID_SPEC_SAPPHIRE));
		register(registry, new FeyStone(FeySlotType.UPGRADE, FeyStoneMaterial.EMERALD).setRegistryName(ID_UPGRADE_EMERALD));
		register(registry, new FeyStone(FeySlotType.UPGRADE, FeyStoneMaterial.GARNET).setRegistryName(ID_UPGRADE_GARNET));
		register(registry, new FeyStone(FeySlotType.UPGRADE, FeyStoneMaterial.AQUAMARINE).setRegistryName(ID_UPGRADE_AQUAMARINE));
		register(registry, new FeyStone(FeySlotType.UPGRADE, FeyStoneMaterial.RUBY).setRegistryName(ID_UPGRADE_RUBY));
		register(registry, new FeyStone(FeySlotType.UPGRADE, FeyStoneMaterial.SAPPHIRE).setRegistryName(ID_UPGRADE_SAPPHIRE));
		register(registry, new FeyStone(FeySlotType.DOWNGRADE, FeyStoneMaterial.EMERALD).setRegistryName(ID_DOWNGRADE_EMERALD));
		register(registry, new FeyStone(FeySlotType.DOWNGRADE, FeyStoneMaterial.GARNET).setRegistryName(ID_DOWNGRADE_GARNET));
		register(registry, new FeyStone(FeySlotType.DOWNGRADE, FeyStoneMaterial.AQUAMARINE).setRegistryName(ID_DOWNGRADE_AQUAMARINE));
		register(registry, new FeyStone(FeySlotType.DOWNGRADE, FeyStoneMaterial.RUBY).setRegistryName(ID_DOWNGRADE_RUBY));
		register(registry, new FeyStone(FeySlotType.DOWNGRADE, FeyStoneMaterial.SAPPHIRE).setRegistryName(ID_DOWNGRADE_SAPPHIRE));
